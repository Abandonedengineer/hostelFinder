...
const EditHostel = (props) => {
    ...
    const [name, setName] = useState(navigation.title);
    const [Description, setDescription] = useState(navigation.subtitle);
    const [Location, setLocation] = useState('');
    const [Contact, setContact] = useState('');
    const [Price, setPrice] = useState(navigation.price);
    ...
    return (
        ...
        >
            ...
            <View style={styles.componentsSection}>
                ...
                <Input placeholder="Location" style={{ borderColor: theme.COLORS.INFO, width: '90%' }} value={name} placeholderTextColor={theme.COLORS.INFO} onChangeText={(Location) => { setLocation(Location) }} />
                <Input placeholder="Contact" style={{ borderColor: theme.COLORS.INFO, width: '90%' }} value={name} placeholderTextColor={theme.COLORS.INFO} onChangeText={(Location) => { setContact(Contact) }} />
